...
@section('FormularioDescripcion','registrar nueva categoria en el sistema')
@section('FormularioActual','Categorias')
@section('FormularioDetalle','Registrar nueva categoria')
...
@section('ContenidoPagina')
    ...
    {!! Form::open(['route' => 'categoria.store', 'method' => 'POST', 'class' => 'form-horizontal', 'files' => true]) !!}
