...
@section('FormularioDescripcion','editar datos del Banner en el sistema')
@section('FormularioActual','Banner')
@section('FormularioDetalle','Editar Banner')
...
@section('ContenidoPagina')
    ...
    {!! Form::model($banner,['route' => ['banner.update',$banner->id], 'method' => 'PUT', 'class' => 'form-horizontal', 'files' => true]) !!}
