...
@section('FormularioDescripcion','editar datos de la biografia en el sistema')
@section('FormularioActual','Biografias')
@section('FormularioDetalle','Editar Biografia')
...
@section('ContenidoPagina')
    ...
    {!! Form::model($biografia,['route' => ['biografia.update',$biografia->id], 'method' => 'PUT', 'class' => 'form-horizontal', 'files' => true]) !!}
