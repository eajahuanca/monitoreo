...
@section('FormularioTitulo','Misiones')
@section('FormularioDescripcion','editar datos de la mision en el sistema')
@section('FormularioActual','Misiones')
@section('FormularioDetalle','Editar Mision')
...
@section('ContenidoPagina')
    ...
    {!! Form::model($vision,['route' => ['vision.update',$vision->id], 'method' => 'PUT', 'class' => 'form-horizontal', 'files' => true]) !!}
