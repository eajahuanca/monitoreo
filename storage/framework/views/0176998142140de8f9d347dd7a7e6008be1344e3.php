...
<?php $__env->startSection('FormularioDescripcion','registrar nueva unidad proponente'); ?>
<?php $__env->startSection('FormularioActual','Unidad'); ?>
<?php $__env->startSection('FormularioDetalle','Registrar nueva Unidad'); ?>
...
<?php $__env->startSection('ContenidoPagina'); ?>
    ...
    <?php echo Form::open(['route' => 'unidad.store', 'method' => 'POST', 'class' => 'form-horizontal']); ?>
